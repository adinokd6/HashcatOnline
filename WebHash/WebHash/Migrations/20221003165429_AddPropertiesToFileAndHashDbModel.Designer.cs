...
namespace WebHash.Migrations
{
    ...
    [Migration("20221003165429_AddPropertiesToFileAndHashDbModel")]
    partial class AddPropertiesToFileAndHashDbModel
    {
            ...
            modelBuilder.Entity("WebHash.DataModels.File", b =>
                {
                    ...
                    b.Property<int>("CrackedPasswords")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnCrackedPasswords")
                        .HasColumnType("int");
